...
public class Tech extends ActivatablePowerHero {
	...
	public void moveUp() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed Move Direction",this, Direction.UP);
	}

	@Override
	public void moveDown() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed Move Direction",this, Direction.DOWN);
	}

	@Override
	public void moveRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed Move Direction",this, Direction.RIGHT);
	}

	@Override
	public void moveLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed Move Direction",this, Direction.LEFT);
	}
